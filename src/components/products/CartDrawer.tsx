                        ...
                        {cart.length > 0 && (
                            <div className="flex-shrink-0 px-5 pb-6 pt-4 border-t border-gray-100 dark:border-gray-800 space-y-4">
                                ...
                                <button
                                    ...
                                    className="w-full py-3 rounded-2xl border border-green-300 dark:border-green-800 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 font-semibold text-sm flex items-center justify-center gap-2 hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors"
                                >
